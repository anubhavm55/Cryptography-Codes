    ...
    public static void main(String args[])
    {
        ...
        switch(choice)
        {
            case 1:System.out.println("Enter plaintext");
                   text=sc.nextLine();
                   System.out.println("Enter key present in Z*26 and key2 for addition in affine cipher");
                   key=sc.nextInt();
                   key2=sc.nextInt();
                   dup1=Z;
                   dup2=key;
                 ...
                 if(dup1!=1)
                 {
                   ...
                   for(i=0;i<length;i++)
                   {
                       ...
                       if((ch>='a')&&(ch<='z'))
                       {
                           ...
                           ch=(char)((ch*key+key2)%26);// doing mod in case of overflow
            ...
            case 2:System.out.println("Enter ciphertext");
                ...
                //Multiplicative Inverse stored in t1
                   ...
                   for(i=0;i<length;i++)
                   {
                     ...
                     {
                        ch=(char)(ch-'a');//subtracting ASCII value from character
                        ch=(char)(((ch+26-key2)*t1)%26);// doing mod in case of overflow
                        ch=(char)(ch+'a');//adding ASCII value back to get corresponding character
                        s=s+ch;
                     }
                     else if((ch>='A')&&(ch<='Z'))
